    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center txt-header-mobile">
                <h1 class="mb-3 bread">Destinasi Wisata</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="/home">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Destinasi Wisata <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
      </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="project-wrap">
                    ...
                    <div class="text p-4">
                        <a href="/paket-wisata"><span class="price"> Lihat Paket </span></a>
                        <h3><a href="#">{{ $dest->title }}</a></h3>
                        {!! $dest->deskripsi !!}
                    </div>
                </div>
            </div>
